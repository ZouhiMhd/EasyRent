...
export const NewCarForm = () => {
  ...
  //   try {
  //     // Envoi de la requête pour enregistrer les informations du véhicule
  //     const responseVehicle = await axios.post('/api/vehicules', vehicleData);
  //     const vehiculeImmatriculation = responseVehicle.data.immatriculation;

  //     // Envoi de la requête pour uploader les images du véhicule
  //     const formData = new FormData();
  //     images.forEach((file, index) => {
  //       formData.append('files', file);
  //     });

  //     const responseImages = await axios.post(/api/vehicules/${vehiculeImmatriculation}/images, formData, {
  //       headers: {
  //         'Content-Type': 'multipart/form-data',
  //       },
  //     });

  //     console.log('Images uploaded:', responseImages.data);
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group controlId="fuel" style={{padding : "10px"}}>
            ...
            <Form.Control as="select" name="fuel" onChange={handleChange}>
                ...
                <option value="A">Yaounde</option>
                <option value="B">Douala</option>
                <option value="C">Petrol</option>
                <option value="D">Electric</option>
            </Form.Control>  
